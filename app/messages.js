...
module.exports = {
  ...
  applicant_header:'About the applicant',
  ...
  address_question_2: 'What was their address at the time of their death?’,
  ...
  will_question_4: ‘Were there any wills outside of England and Wales?',
  ...
  iht_question_3: 'Gross Estate figure (Â£)',
  iht_question_hint_3: 'Whole pounds only',  
  iht_question_4: 'Net Estate figure (Â£)',
  iht_question_hint_4: 'Whole pounds only',

  executors_question_1: 'Please list all of the executors named in the Will',
  ...
  stop_foreign_domicile: ‘The person who died was not domiciled in England or Wales. You cannot complete the application online. Contact the Probate Registry for help.',
  stop_no_will: ‘The original will is not available. You cannot complete the application online without the original will. Contact the Probate Registry for help.',
