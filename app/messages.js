...
module.exports = {
  ...
  executorsnotapplying_radio_reserved: 'They have chosen not to apply but reserve the right to do so later (power reserved)',
  executorsnotapplying_radio_renunciation: 'They have chosen not to apply, and have given up all rights to apply (renunciation)',
  executorsnotapplying_radio_attorney: 'They will appoint another person to apply on their behalf (power of attorney)',
